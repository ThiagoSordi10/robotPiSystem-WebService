...
<body>
	...
	<c:set value="${contextPath }/empresa/form" var="cadastro" />
	<c:set value="${contextPath }/empresa" var="lista" />
		...
		<div class="navbar-fixed">
			<nav>
				<div class="nav-wrapper white">
					<a href="${index}" class="brand-logo" style="color: gray; font-style: bold; margin-left: 2%;"> Robot PI</a>
